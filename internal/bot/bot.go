...
func (b *Bot) registerHandlers() {
	...
	privateGroup.Handle("/setbotdelete", b.handleSetBotDelete)
	privateGroup.Handle("/delbotdelete", b.handleDelBotDelete)
	privateGroup.Handle("/listbotdelete", b.handleListBotDelete)
